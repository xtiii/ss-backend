...
//基本设置--------------------------------------------------------------------------------------------
$System_Config['key'] = '607573923006';						//!!! 瞎 jb 修改此key为随机字符串确保网站安全 !!!
...
$System_Config['email_verify_iplimit']='5';		//验证码有效期内，单IP可请求验证码次数


//已注册用户设置---------------------------------------------------------------------------------------
#基础
$System_Config['checkinMin'] = '0';				//用户签到最少流量 单位MB
...
#管理员联系方式设置
$System_Config['enable_admin_contact']='ture';			//是否开启管理员联系方式
$System_Config['admin_contact1'] = 'QQ：865890126';		//QQ、邮箱、微信仅用于举例
$System_Config['admin_contact2'] = '邮箱865890126@qq.com';	//也可以写电话、tg等其他联系方式
$System_Config['admin_contact3'] = '微信：zlt990828';		//没有格式要求，想怎么写就怎么写，可留空
